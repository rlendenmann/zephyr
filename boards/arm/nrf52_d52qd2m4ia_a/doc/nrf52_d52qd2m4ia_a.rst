...
Zephyr applications use the nrf52_d52qd2m4ia_a module configuration
to run on the nRF52 Dynastream module (D52QD2M4IA-A) hardware. It provides
...
* LIS2DH (STM Accelerometer)
* Segger RTT (RTT Console)

.. figure:: img/nrf52_d52qd2m4ia_a.jpg
     :width: 1024px
     :align: center
     :alt: nRF52 D52QD2M4IA-A DK

     nRF52 D52QD2M4IA-A Module with fly wiring of uart and swdio interface
...
The nrf52_d52qd2m4ia_a board configuration supports the following
hardware features:
...
#. To build the Zephyr kernel, enter:
   ...
   .. code-block:: console
      ...
      $ cd $ZEPHYR_BASE
      $ make -C samples/subsys/shell/shell BOARD=nrf52_d52qd2m4ia_a
...
your board. The button and LED definitions can be found in :file:`boards/arm/nrf52_d52qd2m4ia_a/board.h`.
